...
export const courseMeta = slopCourseMetaSchema.parse({
  code: "SLOP4605",
  title: "One Shot, No Refunds: The Design of Captive Public Machines",
  session: "Semester 1",
  year: 2027,
  level: 4,
  ...
  endDate: "2027-05-28",
  description:
    "SLOP4605 studies public machines that give a stranger exactly one " +
    "attempt, under a queue's pressure, to complete a transaction they " +
    "can't opt out of — parking meters, airport kiosks, ATMs, ticket " +
    "gates — and asks, every week, who profits when the interface is " +
    "the one that fails.",
  tags: ["captive interfaces", "incentive design", "kiosks & meters"],
